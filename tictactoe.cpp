#include <iostream>
#include <thread>//A thread is a fundamental unit of execution within a program. It represents a single sequence of instructions that can run independently.
#include <chrono>//The <chrono> library provides tools for working with time and duration.
#include <iomanip>
using namespace std;
...
void update_records() {
    if (!draw) {
        ...
        Diagonal2++;
        player2.totalPoints += 10;// Diagonal win

            }
        else {
        player2.totalPoints += 5;  // Regular win
            }
        }
        else if (turn == 'O') {
        player1.totalWins++;
        ...
        board[0][2] == board[1][1] && board[0][2] == board[2][0]) {
        Diagonal1++;
        player1.totalPoints += 10;  // Diagonal win

            }
        else {
        player1.totalPoints += 5;  // Regular win
            }
        }
    }
     else {
...
void display_records() {
    ...
    cout << left << setw(20) <<"\t| >Diagonal Wins: " << right << setw(10) << Diagonal1 << " |\n";
    ...
    cout << left << setw(20) <<"\t| >Diagonal wins: " << right << setw(10) << Diagonal2 << " |\n";
